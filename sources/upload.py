...
def getsha(name=None):
    name = name or "list.json"
    return requests.get("https://api.github.com/repos/jason-bowen-zheng/jason-bowen-zheng.github.io/contents/sources/images/%s" % name).json()["sha"]
